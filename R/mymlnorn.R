...
#' @param mu sequence of mu
#' @param sig sequence of sig
#' @param ...
#'
#' @return graph of the likelyhood estimates for the population mean and standard deviation.
#' @export
#'
#' @examples mymlnorm(x,mu=10,sig=10)
